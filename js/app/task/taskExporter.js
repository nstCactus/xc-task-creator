 ...
 */
define(['jquery', 'rejs!task/templates/export', 'rejs!task/templates/save', 'app/helper', 'formats/tsk', 'formats/geoJson', 'formats/kml', 'formats/xctrack', 'formats/FsTask', 'formats/FsDB', 'formats/lk8000', 'formats/qrcode', 'jquery-qrcode'], function($, taskE, taskS, helper, tsk, geoJson, kml, xctrack, FsTask, FsDB, lk8000, QRCode) {
    var formats = [tsk, xctrack, kml, geoJson, FsTask, FsDB, lk8000, QRCode, ];
