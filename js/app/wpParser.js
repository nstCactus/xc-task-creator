 ...
 */
define(['jquery', 'waypoints/waypoints', 'task/task', 'tracks/tracks', 'formats/wpt','formats/oziOld', 'formats/ozi', 'formats/cup', 'formats/igc', 'formats/geoJson', 'formats/tsk', 'formats/gpx', 'formats/xctrack', 'formats/FsTask' , 'formats/FsDB', 'formats/kml' , 'jgrowl'],
function($, waypoints, task, tracks, wpt, oziOld, ozi, cup, igc, geoJson, tsk, gpx, xctrack, FsTask , FsDB , kml) {
 
  var formats = [wpt, oziOld, ozi, cup, igc, geoJson, tsk, gpx, xctrack, FsTask , FsDB , kml] ; 
